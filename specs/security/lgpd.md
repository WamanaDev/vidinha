...
| Foto de perfil (avatar)                    | Imagem enviada pelo usuário (JPEG/PNG/WEBP, até 5MB)                     | Execução de contrato (personalização do app) / consentimento       | Vidinha = controlador; Supabase Storage = operador           |
